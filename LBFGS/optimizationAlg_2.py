...
def lbfgs(J, m0, m, bulksp, datasp, iterMax, alpha, beta, c, verbose, eps, gamma, tol, Kmax, plot_on, jetargs):
...
#    df_old = vcl.Vector(bulksp)
    ...
    while df.norm() > tol and k <= Kmax:
        ...
        p = lsalg_1.descent_direction_1(df, k, m, s_set, y_set, gamma)
        m_old.copy(mest)
        [i, mest, jtot, ktot] = lsalg_1.bt_lineSearch_1(J, mest , df, p, k, iterMax, alpha, beta, c, verbose, jtot, ktot, jetargs)
